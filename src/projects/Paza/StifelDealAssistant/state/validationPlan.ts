...
export const DEFAULT_VALIDATION_PLAN: ValidationPlanPhase[] = [
  {
    ...
    title: 'Collect questions from the email thread',
    description: 'Read the forwarded bidder Q&A thread and preserve bidder, category, timestamp, and thread context.',
    required: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Compare new questions against active and answered Q&A threads so the deal team can merge repeated buyer requests.',
    required: true,
  },
  {
