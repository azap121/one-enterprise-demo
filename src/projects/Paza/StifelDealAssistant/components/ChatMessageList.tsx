          ...
          return (
            <MessageShell key={message.id} role="assistant" showAssistantAvatar>
              <Stack spacing={1.5}>
                ...
                <ThinkingTimeline
                  steps={state.flow === 'filing' ? getFilingSpec(state.filingVariant).steps : state.flow === 'brief' ? briefRunSteps : recommendationSteps}
          ...
          return (
            <MessageShell key={message.id} role="assistant" showAssistantAvatar>
              <Stack spacing={1.5}>
                ...
                <ThinkingTimeline
                  steps={state.flow === 'filing' ? getFilingSpec(state.filingVariant).saveSteps : saveSteps}
              ...
              <Stack spacing={1.5}>
                <Stack spacing={0.5}>
                  <Typography sx={{ fontWeight: 650, fontSize: 16 }}>
                    {state.flow === 'filing' ? getFilingSpec(state.filingVariant).copy.savedTitle : COPY.savedTitle}
                  </Typography>
                  <Typography sx={{ fontSize: 13, color: 'text.secondary' }}>
                    {message.content}
                  </Typography>
