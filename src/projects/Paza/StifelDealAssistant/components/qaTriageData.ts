...
// Stifel Q&A telemetry. QUARTET(P6): calibrate owners to the deal team's real division of labor.
...
export const QA_DISCOVERY_PROMPTS = [
  'Who categorizes bidder questions today — the deal team or the client?',
