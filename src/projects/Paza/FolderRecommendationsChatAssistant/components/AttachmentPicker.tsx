...
export default function AttachmentPicker({
  ...
  return (
    <HaloDialog
      ...
      actions={
        <>
          <HaloButton variant="outlined" onClick={() => setDraftFileIds([])} sx={{ textTransform: 'none' }}>
            Clear all
          </HaloButton>
          <Box sx={{ flex: 1 }} />
      ...
      <Stack spacing={1.5}>
        ...
        >
          ...
          <InputBase
            ...
            placeholder="Search seller index"
            sx={{ flex: 1, minWidth: 0, fontSize: 13 }}
            inputProps={{ 'aria-label': 'Search seller index attachments' }}
          />
          {query ? (
              ...
              <Stack spacing={0.25}>
                {visibleFiles.length > 0 ? (
                  ...
                  <Stack alignItems="center" justifyContent="center" spacing={1} sx={{ minHeight: 220, color: 'text.secondary' }}>
                    ...
                    <Typography sx={{ fontSize: 13 }}>No matching documents.</Typography>
                  </Stack>
                )}
              </Stack>
            ) : (
              <Box role="tree" aria-label="Seller index attachment picker" sx={{ minWidth: 620 }}>
          ...
          >
            ...
            {selectedFiles.length > 0 ? (
              ...
              <Typography sx={{ fontSize: 12.5, color: 'text.secondary', lineHeight: 1.5 }}>
                Choose one or more documents to add context to the Datasite AI prompt.
              </Typography>
            )}
          </Stack>
        </Stack>
